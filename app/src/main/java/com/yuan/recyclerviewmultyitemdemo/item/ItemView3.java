...
@Item(type = 3)
public class ItemView3 extends LinearLayout implements IItemVew {
    ...
    public ItemView3(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initialize();
    }

    protected void initialize() {
        inflate(getContext(), R.layout.item_layout_3, this);
